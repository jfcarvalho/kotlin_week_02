...
class TestMastermindRepeatedLetters {
    ...
    @Test
    fun test27() = testEvaluation("DAAE", "AABC", 1, 1)
    @Test
    fun test28() = testEvaluation("BDAD", "AAAE", 1, 0)
    @Test
    fun test29() = testEvaluation("FDDB", "CABB", 1, 0)
    @Test
    fun test30() = testEvaluation("BDBC", "DDFC", 2, 0)
    @Test
    fun test31() = testEvaluation("ECDE", "CEEE", 1, 2)
    @Test
    fun test32() = testEvaluation("BCDA", "AFEA", 1, 0)
    /*@Test
    fun test33() = testEvaluation("BACD", "EAFF", 1, 0)
    @Test
    fun test34() = testEvaluation("BACD", "EAFF", 1, 0)
    @Test
    fun test35() = testEvaluation("BACD", "EAFF", 1, 0)
    */
}
